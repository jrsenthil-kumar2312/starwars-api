...
class StarWarsCharacters:
    ...
    def _generate_star_wars_characters_file_name(self) -> str:
        ...
        return f"star_wars_characters_{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.csv"
    ...
    def transform_star_wars_characters_data(self, star_wars_characters: list) -> Table | None:
        ...
        star_wars_characters_table = etl.cutout(
            star_wars_characters_table, "url", "films", "species", "vehicles", "starships", "created"
        )
        ...
        transformed_star_wars_characters_table = etl.convert(
            star_wars_characters_table, "homeworld", lambda v: self._get_homeworld_name(v))
    ...
    def save_star_wars_csv_file_metadata(star_wars_characters_file_name: str) -> None:
        ...
        star_wars_repo.save(star_wars_characters_file_name=star_wars_characters_file_name)
